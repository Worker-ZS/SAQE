...
def parse_args(args=None):
    ...
    parser.add_argument('--backbone_type', default='SAQE', type=str, choices=['SAQE','QTO', 'CQD'])
...
def main(args):
    ...
    if args.backbone_type == 'SAQE' and args.adj_path is not None:
        logging.info('Loading SAQE checkpoint %s...' % args.adj_path)
